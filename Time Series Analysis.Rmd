...
```{r}
data_vector<-sample(1:3,50,replace = T)+abs(rnorm(50))
...
time_series <- ts(data_vector,star=2004, frequency=4)
...
```
# cap 2 tranformciones

![ts2](/imagenes/ts2.png)


dice que la del centro fila 2 son impredecibles
...
#♥ si cambiamos a 2 es serie exponencial, 3 ... 1 es tendencia lineal
# Plot random_walk
ts.plot(random_walk)
